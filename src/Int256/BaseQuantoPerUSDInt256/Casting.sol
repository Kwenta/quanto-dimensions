...
function to128(BaseQuantoPerUSDInt256 x) pure returns (BaseQuantoPerUSDInt128 result) {
...
function toUint(BaseQuantoPerUSDInt256 x) pure returns (BaseQuantoPerUSDUint256 result) {
