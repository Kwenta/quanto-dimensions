...
function divToDimensionless(USDPerQuantoInt256 x, USDPerQuantoInt256 y) pure returns (int256 result) {
    result = x.unwrap() / y.unwrap();
}

/// @notice Implements the ceiling division of USDPerQuantoInt256 by USDPerQuantoInt256 to dimensionless.
function ceilDivide(USDPerQuantoInt256 x, USDPerQuantoInt256 y) pure returns (int256) {
