...
function add(QuantoInt128 x, QuantoInt128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap() + y.unwrap());
}

/// @notice Implements the checked subtraction operation (-) in the QuantoInt128 type.
function sub(QuantoInt128 x, QuantoInt128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap() - y.unwrap());
}
...
/// @notice Implements the AND (&) bitwise operation in the QuantoInt128 type.
function and2(QuantoInt128 x, QuantoInt128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap() & y.unwrap());
}
...
function mod(QuantoInt128 x, QuantoInt128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap() % y.unwrap());
}
...
function or(QuantoInt128 x, QuantoInt128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap() | y.unwrap());
}

/// @notice Implements the XOR (^) bitwise operation in the QuantoInt128 type.
function xor(QuantoInt128 x, QuantoInt128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap() ^ y.unwrap());
}
...
function mulDecimal(QuantoInt128 x, int128 y) pure returns (QuantoInt128 result) {
    result = wrap(x.unwrap().mulDecimal(y).to128());
}

/// @notice Multiplies quanto and usd/quanto to get usd
function mulDecimalToUSD(QuantoInt128 x, USDPerQuantoInt128 y) pure returns (USDInt128 result) {
