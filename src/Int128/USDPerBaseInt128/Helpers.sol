...
function add(USDPerBaseInt128 x, USDPerBaseInt128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() + y.unwrap());
}

/// @notice Implements the checked subtraction operation (-) in the USDPerBaseInt128 type.
function sub(USDPerBaseInt128 x, USDPerBaseInt128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() - y.unwrap());
}

/// @notice Implements the AND (&) bitwise operation in the USDPerBaseInt128 type.
function and(USDPerBaseInt128 x, int128 bits) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() & bits);
}

/// @notice Implements the AND (&) bitwise operation in the USDPerBaseInt128 type.
function and2(USDPerBaseInt128 x, USDPerBaseInt128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() & y.unwrap());
}
...
function mod(USDPerBaseInt128 x, USDPerBaseInt128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() % y.unwrap());
}
...
function or(USDPerBaseInt128 x, USDPerBaseInt128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() | y.unwrap());
}

/// @notice Implements the XOR (^) bitwise operation in the USDPerBaseInt128 type.
function xor(USDPerBaseInt128 x, USDPerBaseInt128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() ^ y.unwrap());
}
...
function mul(USDPerBaseInt128 x, int128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() * y);
}

/// @notice Multiplies usd/base and dimensionless to get usd/base
function mulDecimal(USDPerBaseInt128 x, int128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap().mulDecimal(y).to128());
}

/// @notice Multiplies usd/base and base to get usd
function mulDecimalToUSD(USDPerBaseInt128 x, BaseInt128 y) pure returns (USDInt128 result) {
    result = USDInt128.wrap(x.unwrap().mulDecimal(y.unwrap()).to128());
}

/// @notice Multiplies usd/base and (base*quanto)/usd to get quanto
function mulDecimalToQuanto(USDPerBaseInt128 x, BaseQuantoPerUSDInt128 y) pure returns (QuantoInt128 result) {
...
function div(USDPerBaseInt128 x, int128 y) pure returns (USDPerBaseInt128 result) {
    result = wrap(x.unwrap() / y);
}
