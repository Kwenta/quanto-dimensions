...
function sub(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() - y.unwrap());
}

/// @notice Implements the AND (&) bitwise operation in the USDPerQuantoUint128 type.
function and(USDPerQuantoUint128 x, uint128 bits) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() & bits);
}

/// @notice Implements the AND (&) bitwise operation in the USDPerQuantoUint128 type.
function and2(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() & y.unwrap());
}
...
function gte(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (bool) {
    return x.unwrap() >= y.unwrap();
}
...
function lte(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (bool) {
    return x.unwrap() <= y.unwrap();
}

/// @notice Implements the modulus operation (%) in the USDPerQuantoUint128 type.
function mod(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() % y.unwrap());
}

/// @notice Implements the not equal operation (!=) in the USDPerQuantoUint128 type.
function neq(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (bool) {
    return x.unwrap() != y.unwrap();
}
...
function or(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() | y.unwrap());
}

/// @notice Implements the XOR (^) bitwise operation in the USDPerQuantoUint128 type.
function xor(USDPerQuantoUint128 x, USDPerQuantoUint128 y) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() ^ y.unwrap());
}

/// @notice Implements the checked addition operation (+1) in the USDPerQuantoUint128 type.
function increment(USDPerQuantoUint128 x) pure returns (USDPerQuantoUint128 result) {
    result = x + wrap(1);
}

/// @notice Implements the checked multiplication operation (*) in the USDPerQuantoUint128 type.
function mul(USDPerQuantoUint128 x, uint128 y) pure returns (USDPerQuantoUint128 result) {
...
function div(USDPerQuantoUint128 x, uint128 y) pure returns (USDPerQuantoUint128 result) {
    result = wrap(x.unwrap() / y);
}
