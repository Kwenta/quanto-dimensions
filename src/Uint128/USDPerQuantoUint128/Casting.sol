...
function to256(USDPerQuantoUint128 x) pure returns (USDPerQuantoUint256 result) {
    result = USDPerQuantoUint256.wrap(unwrap(x).to256());
}

/// @notice Converts a USDPerQuantoUint128 number into USDPerQuantoInt128.
function toInt(USDPerQuantoUint128 x) pure returns (USDPerQuantoInt128 result) {
