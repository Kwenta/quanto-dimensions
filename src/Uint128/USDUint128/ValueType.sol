...
/// @notice Divides USDUint128 and USDUint128 to dimensionless
function divDecimalToDimensionless(USDUint128 x, USDUint128 y)
    pure
...
function greaterThanZero(USDUint128 x) pure returns (bool) {
    return x.unwrap() > 0;
}
