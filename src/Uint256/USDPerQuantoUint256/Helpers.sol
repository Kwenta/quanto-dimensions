...
function sub(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() - y.unwrap());
}

/// @notice Implements the AND (&) bitwise operation in the USDPerQuantoUint256 type.
function and(USDPerQuantoUint256 x, uint256 bits) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() & bits);
}

/// @notice Implements the AND (&) bitwise operation in the USDPerQuantoUint256 type.
function and2(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() & y.unwrap());
}
...
function gte(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (bool) {
    return x.unwrap() >= y.unwrap();
}
...
function lte(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (bool) {
    return x.unwrap() <= y.unwrap();
}

/// @notice Implements the modulus operation (%) in the USDPerQuantoUint256 type.
function mod(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() % y.unwrap());
}

/// @notice Implements the not equal operation (!=) in the USDPerQuantoUint256 type.
function neq(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (bool) {
    return x.unwrap() != y.unwrap();
}
...
function or(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() | y.unwrap());
}

/// @notice Implements the XOR (^) bitwise operation in the USDPerQuantoUint256 type.
function xor(USDPerQuantoUint256 x, USDPerQuantoUint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() ^ y.unwrap());
}
...
function mul(USDPerQuantoUint256 x, uint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() * y);
}

/// @notice Multiplies usd/quanto and dimensionless to get usd/quanto
function mulDecimal(USDPerQuantoUint256 x, uint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap().mulDecimal(y));
}

/// @notice Multiplies usd/quanto and quanto to get usd
function mulDecimalToUSD(USDPerQuantoUint256 x, BaseUint256 y) pure returns (USDUint256 result) {
    result = USDUint256.wrap(x.unwrap().mulDecimal(y.unwrap()));
}

/// @notice Multiplies usd/quanto and (base*quanto)/usd to get base
function mulDecimalToBase(USDPerQuantoUint256 x, BaseQuantoPerUSDUint256 y) pure returns (BaseUint256 result) {
...
function div(USDPerQuantoUint256 x, uint256 y) pure returns (USDPerQuantoUint256 result) {
    result = wrap(x.unwrap() / y);
}
