...
import {BaseQuantoPerUSDUint128, BaseQuantoPerUSDInt128, BaseQuantoPerUSDUint256, BaseUint128, QuantoUint128, USDPerBaseUint128, USDPerQuantoUint128, USDUint128} from "src/UnitTypes.sol";
...
contract BaseQuantoPerUSDUint128Test is Test {
    ...
    function testBaseQuantoPerUSDUint128EqFuzz(uint128 x, uint128 y) public {
        bool z = x == y;
        bool result = BaseQuantoPerUSDUint128.wrap(x) ==
            BaseQuantoPerUSDUint128.wrap(y);
        assertEq(result, z);
    }
    ...
    function testBaseQuantoPerUSDUint128IncrementFuzz(uint128 x) public {
        ...
        if (z < x) {
            ...
            BaseQuantoPerUSDUint128 result = BaseQuantoPerUSDUint128
                .wrap(x)
                .increment();
    ...
    function testBaseQuantoPerUSDUint128MulDecimalFuzz(
        uint128 x,
        uint128 y
    ) public {
        uint128 z;
    ...
    function testBaseQuantoPerUSDUint128MulDecimalToQuantoFuzz(
        ...
        if (
            ...
            QuantoUint128 result = BaseQuantoPerUSDUint128
                .wrap(x)
    ...
    function testBaseQuantoPerUSDUint128MulDecimalToBaseFuzz(
        ...
        if (
            ...
            BaseUint128 result = BaseQuantoPerUSDUint128
                .wrap(x)
