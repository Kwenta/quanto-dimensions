...
import {BaseQuantoPerUSDUint128, BaseUint128, QuantoUint128, USDPerBaseUint128, USDPerBaseUint256, USDPerBaseInt128, USDPerQuantoUint128, USDUint128} from "src/UnitTypes.sol";
...
contract USDPerBaseUint128Test is Test {
    ...
    function testUSDPerBaseUint128MulDecimalToUSDFuzz(
        uint128 x,
        uint128 y
    ) public {
        uint128 z;
        ...
        if (
            ...
            USDUint128 result = USDPerBaseUint128.wrap(x).mulDecimalToUSD(
                BaseUint128.wrap(y)
            );
            assertEq(result.unwrap(), z);
        }
    ...
    function testUSDPerBaseUint128MulDecimalToQuantoFuzz(
        uint128 x,
        uint128 y
    ) public {
        uint128 z;
