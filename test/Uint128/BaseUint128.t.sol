...
contract BaseUint128Test is Test {
    ...
    function testBaseUint128Max128() public {
        BaseUint128 x = BaseUint128.wrap(100);
        BaseUint128 y = BaseUint128.wrap(200);
        BaseUint128 result = x.max128(y);
        assertEq(result.unwrap(), y.unwrap());
    }

    function testBaseUint128Max128Fuzz(uint128 x, uint128 y) public {
        uint128 z = x < y ? y : x;
        BaseUint128 result = BaseUint128.wrap(x).max128(BaseUint128.wrap(y));
        assertEq(result.unwrap(), z);
    }

    function testBaseUint128Min128() public {
        BaseUint128 x = BaseUint128.wrap(100);
        BaseUint128 y = BaseUint128.wrap(200);
        BaseUint128 result = x.min128(y);
        assertEq(result.unwrap(), x.unwrap());
    }

    function testBaseUint128Min128Fuzz(uint128 x, uint128 y) public {
        uint128 z = x < y ? x : y;
        BaseUint128 result = BaseUint128.wrap(x).min128(BaseUint128.wrap(y));
        assertEq(result.unwrap(), z);
    }

    function testBaseUint128Max() public {
        BaseUint128 x = BaseUint128.wrap(100);
        BaseUint128 y = BaseUint128.wrap(200);
    ...
    function testBaseUint128MaxFuzz(uint128 x, uint128 y) public {
        uint128 z = x < y ? y : x;
        BaseUint256 result = BaseUint128.wrap(x).max(BaseUint128.wrap(y));
        assertEq(result.unwrap(), uint256(z));
    }

    function testBaseUint128Min() public {
        BaseUint128 x = BaseUint128.wrap(100);
        BaseUint128 y = BaseUint128.wrap(200);
    ...
    function testBaseUint128MinFuzz(uint128 x, uint128 y) public {
        uint128 z = x < y ? x : y;
        BaseUint256 result = BaseUint128.wrap(x).min(BaseUint128.wrap(y));
        assertEq(result.unwrap(), uint256(z));
    }

    function testBaseUint128Zero() public {
        BaseUint128 x = InteractionsBaseUint128.zero();
        assertEq(x.unwrap(), 0);
    }

    function testBaseUint128isZero() public {
        BaseUint128 x = BaseUint128.wrap(0);
        BaseUint128 y = BaseUint128.wrap(100);
    ...
    function testBaseUint128isZeroFuzz(uint128 x) public {
        BaseUint128 result = BaseUint128.wrap(x);
    ...
    function testBaseUint128DivDecimalToDimensionless() public {
        BaseUint128 x = BaseUint128.wrap(500 ether);
        BaseUint128 y = BaseUint128.wrap(2 ether);
        uint256 result = x.divDecimalToDimensionless(y);
        assertEq(result, 250 ether);
    }

    function testBaseUint128DivDecimalToDimensionlessFuzz(uint128 x, uint128 y)
        public
    {
        uint256 z;
        uint256 j;
        ...
        if (mulOverflow || y == 0) {
            vm.expectRevert();
            BaseUint128.wrap(x).divDecimalToDimensionless(BaseUint128.wrap(y));
        } else {
            uint256 result = BaseUint128.wrap(x).divDecimalToDimensionless(
                BaseUint128.wrap(y)
            );
            assertEq(result, z);
        }
